...
export default function Edit({ order, customers, products }) {
    ...
    return (
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800 leading-tight">
                            แก้ไขใบสั่งซื้อ: <span className="font-mono text-indigo-600">{order.order_number}</span>
                        </h2>
                    </div>
                    <Link
        ...
        >
            <Head title={`แก้ไขใบสั่งซื้อ ${order.order_number}`} />
            ...
            <div className="py-8 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="เช่น ที่อยู่จัดส่งเพิ่มเติม, เลขพัสดุ"
                                className="w-full text-sm rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
                        <div className="flex items-center justify-between border-b pb-2">
                            <div>
                                ...
                                <p className="text-xs text-gray-500">ปรับเปลี่ยนจำนวนหรือเพิ่ม/ลบรายการสินค้า</p>
                            </div>
                            <button
                                type="button"
                                onClick={addItemRow}
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        >
                            {processing ? 'กำลังบันทึก...' : 'อัปเดตใบสั่งซื้อ'}
                        </button>
                    </div>
                </form>
            </div>
